  ...
  return new Hono()
    ...
    .get('/', async (c) => {
      ...
      const result = await store.list({
        ...
        cursor: isNaN(cursor as number) ? undefined : cursor,
    ...
    .patch('/:id', async (c) => {
      ...
      if (body.messageCount !== undefined) updateFields.messageCount = body.messageCount
      if (body.lastMessagePreview !== undefined) updateFields.lastMessagePreview = body.lastMessagePreview
      if (body.lastMessageAt !== undefined) updateFields.lastMessageAt = body.lastMessageAt
