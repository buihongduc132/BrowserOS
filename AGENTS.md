...
This project is indexed by GitNexus as **BrowserOS** (24488 symbols, 49256 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
